...
<body style="background-color:#7277E8;">
  ...
  <div>
    <input type="checkbox" id="Davechoice" value="150$">
    <label for="Davechoice">Matcha Latte- $</label>150
    <input type="number" value="1" min="1">
  </div> 
...
<div>
 ...
 <div>
    <input type="checkbox" id="Davechoice" value="150$">
    <label for="Davechoice">Salad- $</label>150
    <input type="number" value="1" min="1">
  </div>

  <div>
    <input type="checkbox" id="Davechoice" value="150$">
    <label for="Davechoice">BLT Sandwich- $</label>150
    <input type="number" value="1" min="1">
  </div>
...
<div>
  ...
  <div>
    <input type="checkbox" id="uwueats" value="150$">
    <label for="Velmachoice">Homemade Cookie- $</label>150
    <input type="number" value="1" min="1">
  </div>
...
<div>
    <input type="checkbox" id="Davechoice" value="200$">
    <label for="Davechoice">Frozen Yoghurt- $</label>200
    <input type="number" value="1" min="1">
  </div>
...
<div style="margin-bottom: 10px;"></div>
  ...
  <div>
    ...
    <label for="Velmachoice">10 Cat Tuccinos- $</label>1600
    <input type="number" value="1" min="1">
  </div>
...
<div>
    ...
    <label for="Velmachoice">The Tabby Snacks- $</label>1200
    <input type="number" value="1" min="1">
  </div>

<div>
    <input type="checkbox" id="uwueats" value="1600$">
    <label for="Velmachoice">A Purr-fect Lunch- $</label>1600
    <input type="number" value="1" min="1">
  </div>
...
<div>
    ...
    <label for="Velmachoice">Daddy Special- $</label>3000
    <input type="number" value="1" min="1">
  </div>

<div>
    <input type="checkbox" id="uwueats" value="5000$">
    <label for="Velmachoice">Mommy Special- $</label>5000
    <input type="number" value="1" min="1">
  </div>
